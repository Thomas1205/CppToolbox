...
//constructors
template<typename T, typename ST> Storage2D<T,ST>::Storage2D() : data_(0), xDim_(0), yDim_(0), size_(0) {}

template<typename T, typename ST> Storage2D<T,ST>::Storage2D(ST xDim, ST yDim) : xDim_(xDim), yDim_(yDim)
{
...
template<typename T, typename ST> Storage2D<T,ST>::Storage2D(ST xDim, ST yDim, const T default_value) : xDim_(xDim), yDim_(yDim)
{
...
//copy constructor
template<typename T, typename ST> Storage2D<T,ST>::Storage2D(const Storage2D<T,ST>& toCopy)
{
...
template<typename T, typename ST>
inline T* Storage2D<T,ST>::direct_access()
{
  return data_;
}

template<typename T, typename ST>
inline const T* Storage2D<T,ST>::direct_access() const
{
  return data_;
}

template<typename T, typename ST>
inline T& Storage2D<T,ST>::direct_access(ST i)
{
  return data_[i];
}
...
template<typename T, typename ST>
inline ST Storage2D<T,ST>::size() const
{
  return size_;
}
