...
/****** implementation of (unnamed) TriangularMatrix and related stand-alone operators ******/
  ...
  template<typename T, typename ST>
  TriangularMatrix<T,ST>::TriangularMatrix(bool lower_triangular) : TriMatrix<T,ST>(), is_lower_triangular_(lower_triangular) {}
  ...
  template<typename T, typename ST>
  TriangularMatrix<T,ST>::~TriangularMatrix() {}
...
/****** implementation of (unnamed) TriangularMatrixAsymAccess ******/
  ...
  template<typename T, typename ST>
  TriangularMatrixAsymAccess<T,ST>::TriangularMatrixAsymAccess(bool lower_triangular) : 
    TriangularMatrix<T,ST>(lower_triangular) {}

  template<typename T, typename ST>
  TriangularMatrixAsymAccess<T,ST>::TriangularMatrixAsymAccess(ST dim, bool lower_triangular) : 
  ...
  template<typename T, typename ST>
  TriangularMatrixAsymAccess<T,ST>::~TriangularMatrixAsymAccess() {}
